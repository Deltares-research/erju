"""Train XGBoost v5 regression model for PGV_z prediction.

Workflow:
  1. Load Parquet v3 dataset (per-line FO features from 5 track lines)
...
from src.ml.xgboost.config_xgb_v5 import CONFIG
...
def main() -> None:
    ...
    print("=" * 70)
    print("XGBoost v5 — PGV_z Regression  (Parquet v3 / per-line FO)")
    print("=" * 70)
