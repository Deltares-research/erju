...
Kept for historical plotting experiments.
"""
        ...
        if file_path.exists():
            try:
                ...
                with h5py.File(file_path, "r") as f:
                    ...
                    im = ax.imshow(
                        np.log10(np.abs(data)), aspect="auto", cmap="jet"
                    ...
                    x_ticks = np.linspace(
                        0, num_channels - 1, num=min(10, num_channels)
                    )
                    ...
                    y_ticks = np.linspace(
                        0, num_time_points - 1, num=min(6, num_time_points)
                    )
...
csv_path = Path(
    r"N:\Projects\11210000\11210064\B. Measurements and calculations\holten\trains_holten_res250_low0.5_up3.csv"
)
data_base_path = Path(r"C:\fo_samples\holten")
save_path = Path(
    r"N:\Projects\11210000\11210064\B. Measurements and calculations\holten"
)
