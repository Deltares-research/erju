...
class BaseFOdata:
    ...
    def create_instance(dir_path: str, first_channel: int, last_channel: int, reader: str):
        ...
        if reader == 'silixa':
            ...
            from src.erju.process_FO_silixa import SilixaFOdata
        ...
        # If reader is 'nptdms', use the NptdmsFindTrains class
            ...
            from src.erju.process_FO_nptdms import NptdmsFOdata
        ...
        # If reader is 'optasense', use the OptasenseFindTrains class
            ...
            from src.erju.process_FO_optasense import OptasenseFOdata
