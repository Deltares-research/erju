...
This script-style module is not part of the main production database creation flow.
Kept for local exploratory work and reference.
"""
...
from scipy.signal import iirfilter, sosfilt, zpk2sos, windows

# Define the directory path
dir_path = r"C:\fo_samples\holten"
...
with h5py.File(file_path, "r") as file:
    ...
    for i in range(num_outputs):
        signal_filt = bandpass(
            data=window * signals[:, i],
            freqmin=1,
            freqmax=100,
            fs=fs,
            corners=5,
    ...
    fig, axes = plt.subplots(
        num_ch_to_plot, 2, figsize=(10, 2 * num_ch_to_plot), sharex=True
    )
